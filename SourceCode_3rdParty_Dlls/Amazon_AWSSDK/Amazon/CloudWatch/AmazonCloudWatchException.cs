namespace Amazon.CloudWatch
{
    ...
    [Serializable]
    public class AmazonCloudWatchException : Exception, ISerializable
    {
        ...
        public AmazonCloudWatchException(Exception innerException) : this(innerException.Message, innerException)
        {
        }
        ...
        protected AmazonCloudWatchException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        ...
        public AmazonCloudWatchException(string message, HttpStatusCode statusCode) : this(message)
        {
            this.statusCode = statusCode;
        }

        public AmazonCloudWatchException(string message, HttpStatusCode statusCode, string errorCode, string errorType, string requestId, string xml) : this(message, statusCode)
        {
