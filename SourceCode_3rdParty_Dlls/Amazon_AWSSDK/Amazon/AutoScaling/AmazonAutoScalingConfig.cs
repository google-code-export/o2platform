namespace Amazon.AutoScaling
{
    ...
    public class AmazonAutoScalingConfig
    {
        ...
        private string serviceURL = "https://autoscaling.amazonaws.com";
        ...
        public AmazonAutoScalingConfig WithMaxErrorRetry(int maxErrorRetry)
        {
            this.maxErrorRetry = maxErrorRetry;
            return this;
        }

        public AmazonAutoScalingConfig WithProxyHost(string proxyHost)
        {
            this.proxyHost = proxyHost;
            return this;
        }

        public AmazonAutoScalingConfig WithProxyPassword(string password)
        {
            this.proxyPassword = password;
            return this;
        }

        public AmazonAutoScalingConfig WithProxyPort(int proxyPort)
        {
            this.proxyPort = proxyPort;
            return this;
        }

        public AmazonAutoScalingConfig WithProxyUsername(string userName)
        {
            this.proxyUsername = userName;
            return this;
        }

        public AmazonAutoScalingConfig WithServiceURL(string serviceURL)
        {
            this.serviceURL = serviceURL;
            return this;
        }

        public AmazonAutoScalingConfig WithSignatureMethod(string signatureMethod)
        {
            this.signatureMethod = signatureMethod;
            return this;
        }

        public AmazonAutoScalingConfig WithSignatureVersion(string signatureVersion)
        {
            this.signatureVersion = signatureVersion;
            return this;
        }

        public AmazonAutoScalingConfig WithUserAgent(string userAgent)
        {
            this.userAgent = userAgent;
            return this;
        }

        public AmazonAutoScalingConfig WithUseSecureStringForAwsSecretKey(bool fSecure)
        {
