namespace Amazon.ElasticLoadBalancing.Model
{
    ...
    {
        private Amazon.ElasticLoadBalancing.Model.DescribeLoadBalancersResult describeLoadBalancersResultField;
        ...
        [XmlElement(ElementName="DescribeLoadBalancersResult")]
        public Amazon.ElasticLoadBalancing.Model.DescribeLoadBalancersResult DescribeLoadBalancersResult
        {
            get
            {
                return this.describeLoadBalancersResultField;
            }
            set
            {
                this.describeLoadBalancersResultField = value;
            }
        }
