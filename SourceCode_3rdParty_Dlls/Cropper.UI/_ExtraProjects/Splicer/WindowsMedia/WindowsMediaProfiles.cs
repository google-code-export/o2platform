...
namespace Splicer.WindowsMedia
{
    ...
    {
        public static string BiggerHighQualityVideo             // DC for 640x48
        {
            get { return ReadStream("BiggerHighQualityVideo.prx"); }
        }    
            ...
            using (
                Stream stream =
                    typeof (WindowsMediaProfiles).Assembly.GetManifestResourceStream(
                        string.Format(CultureInfo.InvariantCulture, "Fusion8.Cropper._ExtraProjects.Splicer.WindowsMedia.{0}", profileName)))                     
