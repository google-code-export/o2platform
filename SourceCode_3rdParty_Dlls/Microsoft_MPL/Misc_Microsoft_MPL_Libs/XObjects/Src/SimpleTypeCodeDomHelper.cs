        ...
        public static CodeExpression CreateFacets(ClrSimpleTypeInfo type)  {
            ...
            if (flags == 0)
                ...
                CodeCastExpression cast = new CodeCastExpression(new CodeTypeReference(Constants.RestrictionFlags), 
                                            new CodePrimitiveExpression(System.Convert.ToInt32(flags, CultureInfo.InvariantCulture.NumberFormat)));
        ...
        private static CodeExpression CreateTypedValueExpression(XmlSchemaDatatype dataType, object value) {
            ...
            switch(typeCode) {
                ...
                case  XmlTypeCode.AnyUri:
                    ...
                    return new CodeObjectCreateExpression(typeof(Uri), new CodePrimitiveExpression(((Uri)value).OriginalString));
                    
                case XmlTypeCode.QName:
                    XmlQualifiedName qname = value as XmlQualifiedName;
                    return new CodeObjectCreateExpression(typeof(XmlQualifiedName), new CodePrimitiveExpression(qname.Name), new CodePrimitiveExpression(qname.Namespace));
