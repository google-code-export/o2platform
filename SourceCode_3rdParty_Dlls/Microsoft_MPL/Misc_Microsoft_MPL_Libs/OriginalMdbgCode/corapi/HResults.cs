...
namespace O2.Debugger.Mdbg.Debugging.CorDebug
{
    public enum HResult
    {
        ...
        CLDB_S_TRUNCATION = unchecked(0x00131106),
        ...
        CLDB_S_NULL = unchecked(0x00131109),
        ...
        CLDB_S_INDEX_TABLESCANREQUIRED = unchecked(0x00131125),
        ...
        TLBX_I_TYPEINFO_IMPORTED = unchecked(0x0013116c),
        TLBX_E_AMBIGUOUS_RETURN = unchecked((int) 0x8013116d),
        TLBX_E_DUPLICATE_TYPE_NAME = unchecked((int) 0x8013116e),
        TLBX_I_USEIUNKNOWN = unchecked(0x0013116f),
        TLBX_I_UNCONVERTABLE_ARGS = unchecked(0x00131170),
        TLBX_I_UNCONVERTABLE_FIELD = unchecked(0x00131171),
        TLBX_I_NONSEQUENTIALSTRUCT = unchecked((int) 0x80131172),
        TLBX_W_WARNING_MESSAGE = unchecked(0x00131173),
        ...
        TLBX_I_TYPE_EXPORTED = unchecked(0x00131179),
        TLBX_I_DUPLICATE_DISPID = unchecked(0x0013117A),
        TLBX_E_BAD_NAMES = unchecked((int) 0x8013117B),
        TLBX_I_REF_TYPE_AS_STRUCT = unchecked(0x0013117C),
        TLBX_E_GENERICINST_SIGNATURE = unchecked((int) 0x8013117D),
        TLBX_E_GENERICPAR_SIGNATURE = unchecked((int) 0x8013117E),
        TLBX_I_GENERIC_TYPE = unchecked(0x0013117F),
        ...
        TLBX_W_NON_INTEGRAL_CA_TYPE = unchecked(0x00131184),
        TLBX_W_IENUM_CA_ON_IUNK = unchecked(0x00131185),
        ...
        META_S_PARAM_MISMATCH = unchecked(0x00131189),
        ...
        META_S_DUPLICATE = unchecked(0x00131197),
        ...
        TLBX_S_REFERENCED_TYPELIB = unchecked(0x001311AC),
        ...
        TLBX_S_NOSTDINTERFACE = unchecked(0x001311B3),
        TLBX_S_DUPLICATE_DISPID = unchecked(0x001311B4),
        ...
        TLBX_W_ENUM_VALUE_TOOBIG = unchecked(0x001311D5),
        ...
        TLBX_W_EXPORTING_AUTO_LAYOUT = unchecked(0x001311D9),
        TLBX_E_TYPED_REF = unchecked((int) 0x801311DA),
        TLBX_W_DEFAULT_INTF_NOT_VISIBLE = unchecked(0x001311DB),
        TLBX_W_BAD_SAFEARRAYFIELD_NO_ELEMENTVT = unchecked(0x001311DE),
        TLBX_W_LAYOUTCLASS_AS_INTERFACE = unchecked(0x001311DF),
        TLBX_I_GENERIC_BASE_TYPE = unchecked(0x001311E0),
        TLBX_E_BITNESS_MISMATCH = unchecked((int) 0x801311E1),
        VLDTR_S_WRN = unchecked(0x00131200),
        VLDTR_S_ERR = unchecked(0x00131201),
        VLDTR_S_WRNERR = unchecked(0x00131202),
        ...
        CORDBG_S_BAD_START_SEQUENCE_POINT = unchecked(0x0013130B),
        CORDBG_S_BAD_END_SEQUENCE_POINT = unchecked(0x0013130C),
        CORDBG_S_INSUFFICIENT_INFO_FOR_SET_IP = unchecked(0x0013130D),
        ...
        CORDBG_S_FUNC_EVAL_HAS_NO_RESULT = unchecked(0x00131316),
        CORDBG_S_VALUE_POINTS_TO_VOID = unchecked(0x00131317),
        CORDBG_E_INPROC_NOT_IMPL = unchecked((int) 0x80131318),
        CORDBG_S_FUNC_EVAL_ABORTED = unchecked(0x00131319),
        ...
        CORDBG_S_NOT_ALL_BITS_SET = unchecked(0x00131C13),
