// <copyright file="EmbossedEffect.cs" company="Cédric Belin">
...
// </copyright>
// <summary>
// 	Implémentation de la classe <c>MiniFramework.Windows.Media.Effects.EmbossedEffect</c>.
// </summary>
...
namespace MiniFramework.Windows.Media.Effects
{
	...
	/// <summary>
	/// Effet qui met la texture cible en relief.
	/// </summary>
	public class EmbossedEffect: ShaderEffect
	{
		...
		/// </summary>
		private static PixelShader pixelShader=new PixelShader { UriSource=new Uri("Resources/Effects/Embossed.ps", UriKind.Relative).MakePack() };

		//// =====================================================================================

		/// <summary>
		/// Initialise une nouvelle instance de la classe <see cref="EmbossedEffect" />.
		/// </summary>
