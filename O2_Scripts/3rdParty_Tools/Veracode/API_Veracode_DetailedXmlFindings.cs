...
namespace O2.XRules.Database.APIs
{
    ...
    {	
    	...
    	public static ascx_TableList show_In_TableList(this List<FlawType> flaws)
    	{
    		return flaws.show_In_TableList("TreeView of Veracode Xml File".showAsForm());		
    	}
    
    	public static ascx_TableList show_In_TableList(this API_Veracode_DetailedXmlFindings apiVeracode , Control control)
    	{
    	...
    	public static ascx_TableList show_In_TableList(this List<FlawType> flaws , Control control)
    	{
				...
				var tableList = control.add_TableList().show(selectedRows);
    	...
    	public static API_Veracode_DetailedXmlFindings show_Flaws_In_SourceCodeViewer(this API_Veracode_DetailedXmlFindings apiVeracode, Control control)
    	{
			...
			treeView.afterSelect<FlawType>(
				(flaw)=>{				
							...
							description.set_Text(flaw.description.fixCRLF());
							treeView.focus();
						});
