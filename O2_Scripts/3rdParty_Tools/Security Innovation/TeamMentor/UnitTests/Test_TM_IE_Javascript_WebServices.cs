...
{	 
    ...
    {    	
    	...
    	[Test]  
    	public string open_IE_and_get_EmptyPage()
    	{			 
    		...
    		return "ok: open_IE_and_get_EmptyPage".jQuery_Append_Body(ie);
    	}  
    	    	
    	//inject_Javascript_jQuery_and_TM_WebServices    	
    	[Test] 
    	public string inject_Javascript_jQuery_and_TM_WebServices()
    	{    		    		
			...
			return "ok: inject_Javascript_jQuery_and_TM_WebServices".jQuery_Append_Body(ie);
    	}
    	
    	//WS_via_IE_getTime
    	[Test]
    	public string WS_via_IE_getTime()
    	{    		    		
    		...
    		return "ok: WS_via_IE_getTime".jQuery_Append_Body(ie);
    	}
    	  
    	//WS_via_IE_getTime 
    	[Test]  
    	public string get_GuiObjects_uniqueStrings_and_guidanceItemsMappings()
    	{			 
			...
			return "ok: get_GuiObjects_uniqueStrings_and_guidanceItemsMappings".jQuery_Append_Body(ie);
    	}  
    	
    	//from_GuiObjects_Create_Raw_Table
		[Test]  
    	public string from_GuiObjects_Create_Raw_Table()
    	{			 									
			"fetching GuiObjects".jQuery_Append_Body(ie);
			ie.eval("TM.WebServices.WS_Data.getGUIObjects()");
    	...
    	[Test]  
    	public string from_GuiObjects_ExtractMappings_And_Create_Raw_Table()
    	{			 									
    	...
    	[Test]
    	public string get_FolderStructure_Libraries()
    	{			 									
			...
			return "ok get_FolderStructure_Libraries".jQuery_Append_Body(ie);
		}
