...
namespace DemoApp
{
    public class WatiNVBNet : WatinScript
    {
        ...
        public WatiNVBNet()
        {
            this.LanguageName = "VB.NET";
            this.settings.CodeLanguage = AppSettings.CodeLanguages.VBNet;
        }
        ...
        public override void AddAlertHandler(string IEName)
        {
            ...
            {
                AddScriptLine("Dim adhdl As AlertDialogHandler = New AlertDialogHandler");
            }
        ...
        public override void AddConfirmHandler(string IEName, DialogResult DlogResult)
        {
            ...
            {
                AddScriptLine("Dim cdhdl As ConfirmDialogHandler = New ConfirmDialogHandler()");
            }
        ...
        {
            PopupCounter++;
            AddScriptLine("Dim " + IEName + "_" + PopupCounter.ToString() + " As IE = IE.AttachToIE(Find.ByUrl(\"" + URL + "\"))");
        ...
        public override void AddLoginDialog(string IEName, string Username, string Password)
        {
            ...
            {
                AddScriptLine("Dim dhdlLogon As LogonDialogHandler = New LogonDialogHandler(\"" + Username + "\",\"" + Password + "\")");
            }

            AddScriptLine(IEName + ".AddDialogHandler(dhdlLogon)");

            // move the most previous "GoTo"
        ...
        public override void AddScriptLine(string Line)
        {
            ...
            if (sbCode.Length == 0)
            {
                sbCode.AppendLine("Dim "+settings.BaseIEName + " As IE = New IE(\"" + MainBrowser.LocationUrl + "\")");
            }
        ...
        public override string DetermineFindMethod(string BrowserName, IHTMLElement element)
        {
            ...
            else
            {
                switch (strFindMethod)
                {
                    ...
                    default: line += "Find.ByCustom(\"" + strFindMethod + "\",\"" + strValue; break;
                }
            }
