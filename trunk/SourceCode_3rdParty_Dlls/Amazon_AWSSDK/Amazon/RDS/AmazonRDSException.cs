namespace Amazon.RDS
{
    ...
    [Serializable]
    public class AmazonRDSException : Exception, ISerializable
    {
        ...
        public AmazonRDSException(Exception innerException) : this(innerException.Message, innerException)
        {
        }
        ...
        protected AmazonRDSException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        ...
        public AmazonRDSException(string message, HttpStatusCode statusCode) : this(message)
        {
            this.statusCode = statusCode;
        }

        public AmazonRDSException(string message, HttpStatusCode statusCode, string errorCode, string errorType, string requestId, string xml) : this(message, statusCode)
        {
