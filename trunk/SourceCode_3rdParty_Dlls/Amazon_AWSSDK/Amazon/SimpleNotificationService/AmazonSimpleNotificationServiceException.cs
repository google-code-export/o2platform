namespace Amazon.SimpleNotificationService
{
    ...
    public class AmazonSimpleNotificationServiceException : Exception, ISerializable
    {
        ...
        public AmazonSimpleNotificationServiceException(Exception innerException) : this(innerException.Message, innerException)
        {
        }
        ...
        {
            this.message = message;
            AmazonSimpleNotificationServiceException exception = innerException as AmazonSimpleNotificationServiceException;
            if (exception != null)
            {
        ...
        public AmazonSimpleNotificationServiceException(string message, HttpStatusCode statusCode, string errorCode, string errorType, string requestId, string xml) : this(message, statusCode)
        {
