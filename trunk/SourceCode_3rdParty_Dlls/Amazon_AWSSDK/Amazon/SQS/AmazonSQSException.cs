namespace Amazon.SQS
{
    ...
    [Serializable]
    public class AmazonSQSException : Exception, ISerializable
    {
        ...
        public AmazonSQSException(Exception innerException) : this(innerException.Message, innerException)
        {
        }
        ...
        protected AmazonSQSException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
