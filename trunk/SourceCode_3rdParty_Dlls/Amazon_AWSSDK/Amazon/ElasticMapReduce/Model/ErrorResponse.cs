namespace Amazon.ElasticMapReduce.Model
{
    ...
    {
        private List<Amazon.ElasticMapReduce.Model.Error> errorField;
        ...
        public List<Amazon.ElasticMapReduce.Model.Error> Error
        {
            get
            {
                if (this.errorField == null)
                {
                    this.errorField = new List<Amazon.ElasticMapReduce.Model.Error>();
                }
