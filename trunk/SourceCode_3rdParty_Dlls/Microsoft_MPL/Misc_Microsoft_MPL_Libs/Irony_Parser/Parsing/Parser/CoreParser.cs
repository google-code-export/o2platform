...
namespace Irony.Parsing { 
  ...
  public partial class CoreParser {
    ...
    private void ExecuteAction() {
        if (Context.CurrentParserState == null)     // DC
        {            
            Context.Status = ParserStatus.Error;    // DC
            Context.AddParserMessage(ParserErrorLevel.Error, new SourceLocation(), "Context.CurrentParserState was null", new object[] { });
            return;                                 // DC
        }
