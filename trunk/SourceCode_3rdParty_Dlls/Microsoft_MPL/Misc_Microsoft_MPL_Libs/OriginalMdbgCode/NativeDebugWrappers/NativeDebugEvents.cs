...
namespace O2.Debugger.Mdbg.Debugging.Native
{
    ...
    public class NativeEvent
    {
        ...
        private readonly NativePipeline m_pipeline;
        ...
        {
            get { return m_pipeline.GetProcess(ProcessId); }
        }
    ...
    public class CreateProcessDebugEvent : NativeEvent
    {
            ...
            : base(pipeline, ref header, ref union)
        {
            ...
            Process.AddModule(new NativeDbgModule(Process, "<main program>", union.CreateProcess.lpBaseOfImage,
                                                  union.CreateProcess.hFile));
        }
    }
    ...
    public class ExitProcessDebugEvent : NativeEvent
    {
        ...
        public override void DoCleanupForContinue()
        {
            ...
            Pipeline.RemoveProcess(ProcessId);
        }
    }
    ...
    public class OutputDebugStringNativeEvent : NativeEvent
    {
        ...
        public string ReadMessage()
        {
            ...
            {
                m_cachedMessage = m_union.OutputDebugString.ReadMessageFromTarget(Process);
            }
    ...
    public abstract class DllBaseNativeEvent : NativeEvent
    {
        ...
        {
            get { return Process.LookupModule(BaseAddress); }
        }
    ...
    public class LoadDllNativeEvent : DllBaseNativeEvent
    {
        ...
        public string ReadImageName()
        {
            ...
            {
                m_cachedImageName = m_union.LoadDll.ReadImageNameFromTarget(Process);
    ...
    public class ExceptionNativeEvent : NativeEvent
    {
        ...
        {
            get { return m_union.Exception.ExceptionRecord.ExceptionCode; }
        }
