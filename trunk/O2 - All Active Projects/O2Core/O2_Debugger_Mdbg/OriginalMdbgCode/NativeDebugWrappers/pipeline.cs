...
namespace O2.Debugger.Mdbg.Debugging.Native
{
    ...
    public sealed class NativePipeline : IDisposable
    {
        ...
        private readonly Dictionary<int, NativeDbgProcess> m_processes = new Dictionary<int, NativeDbgProcess>();
        ...
        public NativeDbgProcess GetProcess(int processId)
        {
            ...
            {
                throw new InvalidOperationException("Process " + processId +
                                                    " is not being debugged by this pipeline. The process may have exited or been detached from.");
            }
        }
