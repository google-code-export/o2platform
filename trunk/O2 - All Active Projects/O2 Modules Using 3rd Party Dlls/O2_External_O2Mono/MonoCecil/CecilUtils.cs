...
namespace O2.External.O2Mono.MonoCecil
{
    public class CecilUtils
    {
        ...
        public static AssemblyDefinition getAssembly(String assemblyToLoad)
        {
           ...
           //     return AssemblyFactory.GetAssembly(Files.getFileContentsAsByteArray(assemblyToLoad));
                ...
                return AssemblyFactory.GetAssembly(assemblyToLoad);
            }
            catch (Exception ex)
            {
                DI.log.ex(ex, "in CecilUtils.getAssembly");
                return null;
            }
        }
        ...
        public static MethodDefinition getAssemblyEntryPoint(string assemblyToLoad)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getAssemblyEntryPoint");
                return null;
            }
        }
        ...
        public static List<ModuleDefinition> getModules(String assemblyToLoad)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getModules");
        ...
        public static List<TypeDefinition> getTypes(String assemblyToLoad)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getTypes");
                return null;
            }
        }
   ...
   /*     public static List<MethodReference> getConstructors(TypeDefinition tType)
        ...
        public static List<MethodDefinition> getMethods(AssemblyDefinition assemblyToLoad)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getMethods");
                return null;
            }
        }
        ...
        public static List<MethodDefinition> getMethodsStatic(TypeDefinition tType)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getMethodsStatic");
                return null;
            }
        }
        ...
        public static MethodDefinition getMethod(TypeDefinition type, string methodToFind, Type[] methodParameters)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getMethod");                
            }
            return null;
        }
                                                           ...
                                                           int iParameterValueIndex)
        {
            try
            {
                DI.log.info("getAttributeValueFromAssembly -  assemblyToLoad: {0}  sAttributeToFetch: {1}  iParameterValueIndex: {2}  ", assemblyToLoad, sAttributeToFetch, iParameterValueIndex);
                AssemblyDefinition assemblyDefinition = AssemblyFactory.GetAssembly(assemblyToLoad);
                foreach (ModuleDefinition moduleDefinition in assemblyDefinition.Modules)
                    foreach (TypeDefinition typeDefinition in moduleDefinition.Types)
                        foreach (MethodDefinition methodDefinition in typeDefinition.Methods)
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getAttributeValueFromAssembly");
                return null;
            }
        }
            ...
            ModuleDefinition moduleDefinition)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getDictionaryWithTypesMappedToNamespaces");
                return null;
            }
        }
        ...
        public static TypeDefinition getType(AssemblyDefinition assemblyDefinition, string nameOfTypeToExtract)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.getType");
                return null;
            }
        }
        ...
        public static string CreateAssemblyFromType(TypeDefinition typeToExtract, string targetFolder)
        {
            ...
            {
                DI.log.ex(ex, "in CecilUtils.CreateAssemblyFromType");
                return null;
            }
        }
