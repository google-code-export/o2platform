...
using V2.O2.External.IE.WebObjects;
using V2.O2.External.IE.Wrapper;
using FluentSharp.O2.Kernel.ExtensionMethods;

namespace V2.O2.External.IE.ExtensionMethods
{
    public static class IE_Controls_ExtensionMethods
    {
        ...
        {
            var browser = (O2BrowserIE)FluentSharp.O2.Kernel.open.webBrowser();
