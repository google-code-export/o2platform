...
namespace V2.O2.External.SharpDevelop.Ascx
{
    public partial class ascx_SourceCodeEditor : UserControl
    {
        ...
        {
            var droppedObject = (FluentSharp.O2.DotNetWrappers.Filters.FilteredSignature)Dnd.tryToGetObjectFromDroppedObject(e, typeof(FluentSharp.O2.DotNetWrappers.Filters.FilteredSignature));
