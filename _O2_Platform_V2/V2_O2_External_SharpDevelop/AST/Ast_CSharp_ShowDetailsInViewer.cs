...
//using FluentSharp.O2.Views.ASCX.MerlinWizard.O2Wizard_ExtensionMethods;
...
namespace V2.O2.External.SharpDevelop.AST
{
    public class Ast_CSharp_ShowDetailsInViewer
    {
        ...
        private void showInSourceCode(object sender, TreeViewEventArgs e)
        {
            ...
            var endLocation = (ICSharpCode.NRefactory.Location)FluentSharp.O2.Kernel.PublicDI.reflection.getProperty("EndLocation",treeNoteTag);
            var startLocation = (ICSharpCode.NRefactory.Location)FluentSharp.O2.Kernel.PublicDI.reflection.getProperty("StartLocation", treeNoteTag);
            var originalObject = FluentSharp.O2.Kernel.PublicDI.reflection.getProperty("OriginalObject", treeNoteTag);
            var text = (string)FluentSharp.O2.Kernel.PublicDI.reflection.getProperty("Text", treeNoteTag);
