...
namespace O2.Debugger.Mdbg.Debugging.CorPublish.NativeApi
{
    ...
    public class CorpubPublishClass : ICorPublish, CorpubPublish
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern void GetProcess([In] uint pid,
    ...
    {
        void EnumProcesses([In, ComAliasName("CorpubProcessLib.COR_PUB_ENUMPROCESS")] COR_PUB_ENUMPROCESS Type,
                           [Out, MarshalAs(UnmanagedType.Interface)] out ICorPublishProcessEnum ppIEnum);
    ...
    public interface ICorPublishAppDomainEnum : ICorPublishEnum
    {
        ...
        int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.Interface)] out ICorPublishAppDomain objects,
    ...
    public interface ICorPublishProcess
    {
        ...
        void GetDisplayName([In] uint cchName, [Out] out uint pcchName,
                            [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder szName);
    }
    ...
    public interface ICorPublishProcessEnum : ICorPublishEnum
    {
        ...
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.Interface)] out ICorPublishProcess objects,
                 [Out] out uint pceltFetched);
    }
}