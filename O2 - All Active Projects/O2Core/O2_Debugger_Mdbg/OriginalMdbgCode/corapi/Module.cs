...
namespace O2.Debugger.Mdbg.Debugging.CorDebug
{
    ...
    {
        private readonly ICorDebugMDA m_mda;
    ...
    {
        private readonly ICorDebugModule m_module;
        ...
        */
        ...
        {
            (m_module as ICorDebugModule2).ApplyChanges((uint) deltaMetadata.Length, deltaMetadata,
                                                        (uint) deltaIL.Length, deltaIL);
        }
