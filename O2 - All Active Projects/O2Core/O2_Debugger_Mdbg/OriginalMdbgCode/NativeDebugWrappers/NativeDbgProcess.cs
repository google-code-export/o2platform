    ...
    public class NativeDbgProcess : IMemoryReader, IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                foreach (NativeDbgModule module in m_modules.Values)
                {
                    module.CloseHandle();
                }
                m_modules.Clear();
        ...
        public void ReadMemory(IntPtr address, byte[] buffer)
        {
            ...
            int lenRead;
            var len = new UIntPtr((uint) buffer.Length);
        ...
        private readonly Dictionary<IntPtr, NativeDbgModule> m_modules = new Dictionary<IntPtr, NativeDbgModule>();
