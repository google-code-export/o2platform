...
using O2.Debugger.Mdbg.Debugging.Native.Private;
using O2.Debugger.Mdbg.Debugging.Native.Private;
using O2.Debugger.Mdbg.Debugging.Native.Private;

// Native structures used privately for the implementation of the pipeline.

namespace O2.Debugger.Mdbg.Debugging.Native.Private
{
...
namespace O2.Debugger.Mdbg.Debugging.Native
{
    ...
    public struct EXCEPTION_RECORD
    {
        ...
        {
            get { return (ExceptionFlags & ExceptionRecordFlags.EXCEPTION_NONCONTINUABLE) != 0; }
        }
    ...
    {
        [FieldOffset(0)] public CREATE_PROCESS_DEBUG_INFO CreateProcess;
        ...
        [FieldOffset(0)] public OUTPUT_DEBUG_STRING_INFO OutputDebugString;
    }
    ...
    {
        [FieldOffset(0)] public DebugEventHeader header;

        [FieldOffset(12)] public DebugEventUnion union;
    }
    ...
    public struct DebugEvent64
    {
        ...
        [FieldOffset(16)] public DebugEventUnion union;
    }
