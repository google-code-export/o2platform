...
namespace O2.Debugger.Mdbg.Tools.Mdbg.Extension
{
    ...
    {
        private readonly int[] ip2lineMapping;
    ...
    public struct OpCodeTypeInfo
    {
        ...
        private readonly int m_Std1;
        private readonly int m_Std2;
    ...
    public enum OpcodeFormat
    {
        ...
        // This is only used internally.  It means the 'opcode' is two byte instead of 1
    } ;
} ;